...
def Login(request):
    ...
    if request.method=="POST":
        ...
        if user.is_staff:
            data_path = 'C:/Users/shyam/PycharmProjects/FaceDetectionSystem/face_detect/images/'
            ...
            face_classifier = cv2.CascadeClassifier(
                'C:/Users/shyam/PycharmProjects/FaceDetectionSystem/face_detect/haarcascade_frontalface_default.xml')
    ...
    if request.method=="POST":
        ...
        while True:
            ...
            if face_extractor(frame) is not None:
                ...
                file_name_path = 'C:/Users/shyam/PycharmProjects/FaceDetectionSystem/face_detect/images/user' + str(count) + '.jpg'
